export default {
  ...
  sidebar: {
    ...
    merchLink: 'Merch',
    merchText:
      'Hier gibt es Shirts, Zip Hoodies und Taschen im PrivacyWeek-Design',
  ...
  chat: {
    ...
    rules: 'Chat-Regeln',
    faqText:
      'Hinweise dazu, wie du dich alternativ mit dem Chat verbinden kannst, findest du in unseren {0}.',
